...
(
  ...
  curl -s https://raw.githubusercontent.com/trudan/bobarr/master/packages/transmission/config/settings.json -o settings.json
)

curl -s https://raw.githubusercontent.com/trudan/bobarr/master/.env -o .env
curl -s https://raw.githubusercontent.com/trudan/bobarr/master/docker-compose.yml -o docker-compose.yml
curl -s https://raw.githubusercontent.com/trudan/bobarr/master/docker-compose.vpn.yml -o docker-compose.vpn.yml
curl -s https://raw.githubusercontent.com/trudan/bobarr/master/docker-compose.wireguard.yml -o docker-compose.wireguard.yml

curl -s https://raw.githubusercontent.com/trudan/bobarr/master/scripts/bobarr.sh -o bobarr.sh
chmod +x ./bobarr.sh
...
echo ""
echo "you can find the documentation here => https://github.com/trudan/bobarr#-bobarr"
